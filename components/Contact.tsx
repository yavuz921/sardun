...
export default function Contact() {
  ...
  return (
    <section id="iletisim" style={{ padding: "128px 64px", backgroundColor: "#0e0e0e" }}>
      <div style={{ maxWidth: 1440, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 24 }}>
        ...
        <div style={{ backgroundColor: "#131313", border: "1px solid #262626", padding: 48, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          <div>
            <h2 style={{ fontSize: 48, fontWeight: 600, lineHeight: 1.2, color: "#e5e2e1", margin: "0 0 32px 0" }}>Bizimle İletişime Geçin</h2>
