  ...
  return (
    ...
    >
      <Suspense fallback={null}>
        <color attach="background" args={["#0f1d2e"]} />
        <fog attach="fog" args={["#0f1d2e", 12, 26]} />

        <hemisphereLight intensity={0.35} color="#cfe0f0" groundColor="#0f1d2e" />
        <directionalLight
          position={[7, 10, 5]}
          intensity={2.1}
          color="#fff4e0"
        ...
        <directionalLight position={[-6, 3, -4]} intensity={0.5} color="#8fb4e0" />
        ...
        <Environment resolution={mobile ? 128 : 256}>
          ...
          <Lightformer form="rect" intensity={0.8} position={[-6, 1, 3]} scale={[6, 6, 1]} rotation={[0, Math.PI / 4, 0]} color="#c9922a" />
          <Lightformer form="ring" intensity={1.4} position={[3, 6, -2]} scale={3} color="#fff4e0" />
        </Environment>
