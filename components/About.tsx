...
export default function About() {
  return (
    <section id="hakkimizda" className="section-padding" style={{ backgroundColor: "#131313" }}>
      <div className="container">
        <div className="about-grid">
          <div style={{ position: "relative" }}>
            <div className="about-corner" style={{ position: "absolute", top: -32, left: -32, width: 128, height: 128, borderTop: "2px solid #f9bc51", borderLeft: "2px solid #f9bc51" }} />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
            ...
            <h2 className="section-title" style={{ fontSize: 48, fontWeight: 600, lineHeight: 1.2, letterSpacing: "-0.01em", color: "#e5e2e1", margin: 0 }}>Çelik Disiplin, <br />Mimari Vizyon.</h2>
            ...
            <div className="badge-grid">
              {badges.map((b) => (
                <div key={b.label} style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: 16, backgroundColor: "#201f1f", border: "1px solid #262626", textAlign: "center", gap: 8 }}>
                  ...
                  <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: "#e5e2e1" }}>{b.label}</span>
                </div>
              ))}
            </div>
          </div>
