...
export default function Hero() {
  return (
    <section id="anasayfa" style={{ position: "relative", height: "100vh", display: "flex", alignItems: "center", overflow: "hidden" }}>
      ...
      <div className="hero-padding container" style={{ position: "relative", zIndex: 20, width: "100%" }}>
        <div style={{ maxWidth: 768, display: "flex", flexDirection: "column", gap: 32 }}>
          <h1 className="hero-title" style={{ fontSize: "clamp(32px, 6vw, 72px)", fontWeight: 700, lineHeight: 1.1, letterSpacing: "-0.02em", color: "#e5e2e1", margin: 0 }}>
            Güçlü Temeller, <br /><span style={{ color: "#f9bc51" }}>Kalıcı Yapılar.</span>
          </h1>
          <p style={{ fontSize: "clamp(16px, 2vw, 18px)", lineHeight: 1.6, color: "#d4c4b0", maxWidth: 480, margin: 0 }}>
