...
export default function Services() {
  return (
    <section id="hizmetler" className="section-padding" style={{ backgroundColor: "#131313" }}>
      <div className="container">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 64, gap: 24, flexWrap: "wrap" }}>
          <div style={{ maxWidth: 480 }}>
            <h2 className="section-title" style={{ fontSize: 48, fontWeight: 600, lineHeight: 1.2, letterSpacing: "-0.01em", color: "#e5e2e1", margin: "0 0 16px 0" }}>Hizmetlerimiz</h2>
